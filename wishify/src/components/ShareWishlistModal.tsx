...
const ShareWishlistModal = ({ wishlistID, isOwner, shareToken, isOpen, setIsOpen }: Props) => {
    ...
    const handleSubmit = (e: FormEvent) => {
        ...
        fetch(`https://api.wishify.ca/wishlists/share`, {
            ...
            body: JSON.stringify({
                wishlist_id: wishlistID, // change to wishlist_id when Nick pushes backend change
                email: inputEmail,
                owner: false,
                blind: false
            })
    ...
    return (
      <Modal open={isOpen} onClose={() => setIsOpen(false)}>
        <Box sx={style}>
          <Typography variant='h6' sx={{ textAlign: 'center', fontWeight: 'bold', color: '#5651e5' }}>Share Wishlist</Typography>
          ...
          { isOwner && 
            <>
                ...
                Enter the email of the person you want to share this wishlist with.
                </Typography>
